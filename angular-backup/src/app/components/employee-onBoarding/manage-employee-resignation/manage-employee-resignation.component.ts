...
@Component({
  ...
  templateUrl: './manage-employee-resignation.component.html',
  styleUrls: ['./manage-employee-resignation.component.css']
})
export class ManageEmployeeResignationComponent implements OnInit {
  ...
  public statusList: any = ["Accept","Rejoin"];
  ...
  getEmployeeResignationList() {
    this.spinner.show();
    let api = "employeeResignation/findByReportingEmployee?employeeId=" + this.employeeId;
