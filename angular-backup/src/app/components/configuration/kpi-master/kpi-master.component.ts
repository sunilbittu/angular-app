...
export class KPIMasterComponent implements OnInit {
  ...
  public headers: any = ["SNo", "KPI Name", "Description", "Action"];
...
public pageSize: number = 10;
  ...
  getIMList() {
    this.spinner.show();
    let api = "insurancecompany/list?companyId=" + this.companyId + '&remarks=' + 'kpi' +'&search=' + this.searchModel+"&page="+this.pageNumber+"&size=10";
