...
@Component({
  selector: 'app-payslip-component-mtd-report',
  templateUrl: './payslip-component-mtd-report.component.html',
  styleUrls: ['./payslip-component-mtd-report.component.css']
})
export class PayslipComponentMtdReportComponent implements OnInit {
  ...
  fetchSalaryComponentList() {
    ...
    .subscribe((data: any) => {
      for(var i=0; i<data.data.length;i++){
        ...
        let result = data.data[i].salarycomponent.includes("MTD");
