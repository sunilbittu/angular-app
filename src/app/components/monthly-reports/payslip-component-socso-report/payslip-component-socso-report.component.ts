...
@Component({
  selector: 'app-payslip-component-socso-report',
  templateUrl: './payslip-component-socso-report.component.html',
  styleUrls: ['./payslip-component-socso-report.component.css']
})
export class PayslipComponentSocsoReportComponent implements OnInit {
  ...
  fetchSalaryComponentList() {
    ...
    .subscribe((data: any) => {
      for(var i=0; i<data.data.length;i++){
        ...
        let result = data.data[i].salarycomponent.includes("SOCSO");
