...
@Component({
  selector: 'app-payslip-component-report',
  templateUrl: './payslip-component-report.component.html',
  styleUrls: ['./payslip-component-report.component.css']
})
export class PayslipComponentReportComponent implements OnInit {
...
public dropdownSettingsSalaryComponent = {
  ...
  fetchSalaryComponentList() {
    ...
    .subscribe((data: any) => {
    this.salaryComponentMasterList = data.data;
    })
    }
