...
export class SOCSOSlabComponent implements OnInit {

  public incometaxHeaders: any = ["From Salary", "To Salary", "Employer Contribution", "Employee Contribution", "Total Contribution","EXPAT-SOCSO", "Action"];
  public slabData: any;
  ...
  fetchIncomeTaxSlabs() {
    this.spinner.show();
    this.crudOperationsService.getList("payslipslab/slobList/socso").subscribe((res: any) => {
      this.spinner.hide();
      this.toggleLoader = true;
  ...
  sortColumn(){
    console.log("socso inside the sortColumn method!");
    this.currentSortDirection = this.currentSortDirection === 'asc' ? 'desc' : 'asc';

    // Sort the slabData array based on the first column
    this.slabData.sort((a: any, b: any) => {
      let valueA = a.fromSalary;  // sorting by 'fromSalary'
      let valueB = b.fromSalary;  // sorting by 'fromSalary'
  ...
  edit(data: any): void {
    ...
    this.form.controls['expat'].setValue(data.expat);
  ...
  submit() {
    ...
    if (!this.isTaxSlabExist) {
     ...
     // const financialYear = { 'financialYearId': this.financialYearModel };
      this.form.value.slabType = "socso";
      if (this.submitText == 'Save') {
  ...
  exportExcel(){
    ...
    let fileType = 'SOCSOSlabMaster.xls';
    let api: any = "payslipslab/slabExport/socso";
