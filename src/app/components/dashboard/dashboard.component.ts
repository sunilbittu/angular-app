...
export class DashboardComponent implements OnInit {
  ...
  fetchTotalResignEmployee() {
    ...
    this.crudOperationsService.getList(api).subscribe((data: any) => {
      ...
      this.doughnutChartData = [this.liveEmployees, this.totalActiveEmployees, this.totalResignEmployees];
    })
    
  }
  //gender 
  public doughnutChartLabels: string[] = ['Total Employees', 'Live Employees', 'Left Employees'];
