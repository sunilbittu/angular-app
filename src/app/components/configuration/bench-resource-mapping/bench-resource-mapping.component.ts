...
@Component({
  selector: 'app-bench-resource-mapping',
  templateUrl: './bench-resource-mapping.component.html',
  styleUrls: ['./bench-resource-mapping.component.css']
})
export class BenchResourceMappingComponent implements OnInit {
  ...
  changeBranchDestination(model: any) {
    this.companyBranchDetailsIdDestination = model.companyBranchDetailsId;
    this.branchNameDestination = model.branchName;
  ...
  changeDepartmentDestination(model: any) {
    this.departmentIdDestination = model.departmentId;
    this.departmentNameDestination = model.departmentName;
  ...
  update() {
    ...
    if(employeeIdList.length > 0 ||  destinationEmployeeIdList.length > 0) {
      ...
      this.spinner.show();
      var filterJson = {
        "sourceEmployeeIds": employeeIdList,
        "destinationEmployeeIds": destinationEmployeeIdList,
        "sourceBranchId": this.companyBranchDetailsId,
        "destinationBranchId": this.companyBranchDetailsIdDestination,
        "sourceDeptId": this.departmentId,
        "destinationDeptId": this.departmentIdDestination,
        "sourceProjectId": this.projectId,
        "destinationProjectId": this.projectIdDestination,
        "sourceBranchName": this.branchName,
        "destinationBranchName": this.branchNameDestination,
        "sourceDeptName": this.departmentName,
        "destinationDeptName": this.departmentNameDestination,
        "sourceProjectName": this.projectName,
        "destinationProjectName": this.projectNameDestination
      }
      let api = 'employee/employee_bench_mapping_update';
